...
export default function App() {
    ...
    const Navigation = () => (
        <nav className="bg-purple-950 text-white px-6 py-4 shadow flex justify-between items-center">
            <div className="font-bold text-xl">Dreamr</div>
    ...
    if (view === 'dashboard') {
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-900 to-indigo-800 text-white">
                <Navigation />
                <div className="p-8">
                    <h1 className="text-3xl font-bold mb-6">Welcome back to Dreamr ✨</h1>
                    <h2 className="text-xl mb-4">Your Dream Journal</h2>
