  ...
  const submitDream = async () => {
    try {
      const res = await fetch('/api/chat', {
        ...
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
        body: JSON.stringify({ category: 'dream', message: dreamText })
      });
      const data = await res.json();
      setDreamText('');
      fetchDreams();
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 to-indigo-800 text-white">
        ...
        <div className="p-8 grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <textarea className="w-full h-40 p-2 text-gray-800 rounded mb-2" value={dreamText} onChange={(e) => setDreamText(e.target.value)} placeholder="Describe your dream..."></textarea>
            <button onClick={submitDream} className="bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded text-white w-full">Submit Dream</button>
